...
class CdpyDe(CdpSdkBase):
    ...
    def list_dbcs(self, cluster_id):
        return self.sdk.call(
            svc='de', func='list_dbcs', ret_field='dbcs', squelch=[
    ...
    def list_vws(self, cluster_id):
        return self.sdk.call(
            svc='de', func='list_vws', ret_field='vws', squelch=[
                Squelch(value='NOT_FOUND', default=list()),
    ...
    def describe_cluster(self, cluster_id):
        return self.sdk.call(
            svc='de', func='describe_cluster', ret_field='cluster', squelch=[
    ...
    def describe_vw(self, cluster_id, vw_id):
        return self.sdk.call(
            svc='de', func='describe_vw', ret_field='vw', squelch=[
                Squelch('NOT_FOUND'), Squelch('INVALID_ARGUMENT')
            ],
            clusterId=cluster_id,
            vwId=vw_id
    ...
    def describe_dbc(self, cluster_id, dbc_id):
        return self.sdk.call(
            svc='de', func='describe_dbc', ret_field='dbc', squelch=[
                Squelch('NOT_FOUND'), Squelch('INVALID_ARGUMENT')
            ],
            clusterId=cluster_id,
            dbcId=dbc_id
    ...
    def list_clusters(self, env_crn=None):
        resp = self.sdk.call(
            svc='de', func='list_clusters', ret_field='clusters', squelch=[
                Squelch(value='NOT_FOUND', default=list())
            ]
        )
        if env_crn:
    ...
    def create_cluster(self, env_crn: str, overlay: bool, aws_public_subnets: list = None,
        ...
        if all(x is not None for x in [az_subnet, az_enable_az]):
            ...
            azure_options = None
        return self.sdk.call(
            svc='de', func='create_cluster', ret_field='clusterId', environmentCrn=env_crn,
    ...
    def delete_cluster(self, cluster_id: str, force: bool = False):
        return self.sdk.call(
            svc='de', func='delete_cluster', squelch=[Squelch('NOT_FOUND')], clusterId=cluster_id, force=force
        )
